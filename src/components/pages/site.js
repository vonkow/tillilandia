    ...
    return (
      <div>
        ...
        <p>
          ...
          Framework and MobX. You can take a look at the source code on <a href="https://github.com/vonkow/tillilandia">github</a>; 
          if you're interested in learning Django and/or React, there are worse 
          places to start.
        </p>
      </div>
    )
